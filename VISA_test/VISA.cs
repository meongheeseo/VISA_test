...
namespace VISA_test
{
    ...
    public enum VisaManufacturer : uint
    {
        Default = 0xFFFF,
        RohdeSchwarz = 0xFAF,
        NationalInstruments = 0xFF6,
        Agilent = 0xFFF,
        Other,
        Unknown
    }
    ...
    internal sealed class VISA
    {
        ...
        const string visaDll = "visa32.dll";
        public static int rmSession = 0;
        public static Boolean bOk = false;
        public static int vi = 0;
        const Int32 maxReadBufferSize = 8192;

        #region EntryPoint
        /// <summary>
        /// Selects loading of the default VISA library
        /// </summary>
        /// <param name="enumManfId">
        /// VisaManufacturer.Default = the primary visa32.dll is loaded,
        /// VisaManufacturer.RohdeSchwarz = rsvisa32.dll is loaded,
        /// VisaManufacturer.Agilent = agvisa32.dll is loaded,
        /// VisaManufacturer.NationalInstruments = visa32.dll is loaded
        /// </param>
        /// <returns>
        /// VI_TRUE = default library value has changed,
        /// VI_FALSE = enumManfId is invalid
        /// </returns>
        /// <remarks>
        /// Call this function before any other VISA library functions.
        /// 
        ...
        /// </remarks>
        [DllImport(visaDll, EntryPoint = "#060", ExactSpelling = true, CharSet = CharSet.Ansi)]
        public extern static UInt16 RsViSetDefaultLibrary(VisaManufacturer enumManfId);

        /// <summary>
        /// Unload previously installed VISA library
        /// </summary>
        [DllImport(visaDll, EntryPoint = "#061", ExactSpelling = true, CharSet = CharSet.Ansi)]
        public extern static void RsViUnloadVisaLibrary();

        /// <summary>
        /// Checks if the VISA library of the given manufacturer is installed
        /// </summary>
        /// <param name="enumManfId">
        /// VisaManufacturer.Default = the primary visa32.dll is loaded,
        /// VisaManufacturer.RohdeSchwarz = rsvisa32.dll is loaded,
        ...
        /// </param>
        /// <returns>
        /// VI_TRUE = VISA library specified is installed,
        /// VI_FALSE = VISA library specified is not installed, or enumManfId is invalid</returns>
        [DllImport(visaDll, EntryPoint = "#062", ExactSpelling = true, CharSet = CharSet.Ansi)]
        public extern static UInt16 RsViIsVisaLibraryInstalled(VisaManufacturer enumManfId);
        ...
        extern public static ViStatus viWaitOnEvent(int vi, ViEventType inEventType, int timeout, ref ViEventType outEventType, ref int outEventContext);

        [DllImport(visaDll, EntryPoint = "#139", CharSet = CharSet.Ansi, SetLastError = true)]
        extern public static ViStatus viInstallHandler(int vi, ViEventType inEventType, VISA.ViHndlr handler, IntPtr userhandle);

        [DllImport(visaDll, EntryPoint = "#140", CharSet = CharSet.Ansi, SetLastError = true)]
        extern public static ViStatus viUninstallHandler(int vi, ViEventType inEventType, VISA.ViHndlr handler, IntPtr userhandle);
